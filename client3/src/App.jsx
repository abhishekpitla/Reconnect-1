...
const Sidebar = () => {
    ...
    const links = [
        { to: '/', icon: '01.', label: 'Feed' },
        { to: '/post', icon: '02.', label: 'Post Activity' },
        { to: '/invites', icon: '03.', label: 'Join Requests' },
        { to: '/friends', icon: '04.', label: 'Connections' },
        { to: '/notifications', icon: '05.', label: 'Notifications', badge: unreadCount },
        { to: '/profile', icon: '06.', label: 'Profile' },
    ];
