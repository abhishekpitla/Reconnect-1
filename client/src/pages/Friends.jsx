                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                    <img
                                        src={
                                            ...
                                            `https://api.dicebear.com/9.x/avataaars/svg?seed=${req.requester?.name}`
                                        }
                                        alt={req.requester?.name}
                                        style={{ width: 44, height: 44, borderRadius: '50%' }}
                                    />
                                    <div style={{ flex: 1 }}>
                                        <h4 style={{ fontSize: '0.95rem' }}>{req.requester?.name}</h4>
                                    ...
                                    <div style={{ display: 'flex', gap: 8 }}>
                                        ...
                                        <button className="btn btn-ghost btn-sm" onClick={() => handleRemove(req.id)}>
                                            Decline
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                    <img
                                        src={
                                            ...
                                            `https://api.dicebear.com/9.x/avataaars/svg?seed=${req.recipient?.name}`
                                        }
                                        alt={req.recipient?.name}
                                        style={{ width: 44, height: 44, borderRadius: '50%' }}
                                    />
                                    <div style={{ flex: 1 }}>
                                        <h4 style={{ fontSize: '0.95rem' }}>{req.recipient?.name}</h4>
                                        <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                                            {req.recipient?.email}
                                        </p>
                                    </div>
