        ...
        <div className="fade-in">
            ...
            <div className="greeting-banner">
                <div className="greeting-content">
                    ...
                    <p className="greeting-subtitle">Here's what your friends have been up to</p>
                </div>
            ...
            {activities.length === 0 ? (
                <div className="empty-state">
                    <img src="/images/wave.png" alt="Wave hello" style={{ width: 120, marginBottom: 20, borderRadius: 20, opacity: 0.8 }} />
